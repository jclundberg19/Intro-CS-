...
let totalTime = brushTeeth + takeShower + getDressed + eatBreakfast + goOnPhone
...
let totalTimeHaveToDo = brushTeeth + getDressed + eatBreakfast
let totalTimeLikeToDo = takeShower + goOnPhone
